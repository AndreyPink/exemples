...
// проходим циклом по массиву и ищем наименьший элемент
// записываем номер строки и столбца мин элемента в отдельный одномерный массив
...
// создаем новый массив меньше старого на 1 строку и 1 столбец
// перезаписываем старый массив в новый игнорируя элементы строки и столбца, относящиеся к минимальному эжлементу
